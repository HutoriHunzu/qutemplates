...
def json_save(path: Path | str, data):
    d = json.dumps(data, cls=JsonEncoder)
...
def generate_unique_save_name(path: str, name: str, suffix: str, saving_time: str,
                              extension: Optional[str] = None) -> Generator[str, None, None]:
    """
