...
def create_program_coordinator_pipeline(flow: Workflow, interface: StreamingInterface) -> ParallelNode:
    """
    ...
    coordinator_node = flow.add_node(
        ParallelNode(
    ...
    post_node = flow.add_node(ParallelNode(OPXNodeName.POST, FuncTask(func=interface.post_run)))
